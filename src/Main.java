public class Main {
    ...
    public static void main(String[] args) {
        clothes []clothes={
                new Pants(Size.XXS,"зелёный",2500),
                new Skirt(Size.S,"красный",1000),
                new Tie(Size.L,"голубой",7999),
                new TeeShirt(Size.M,"орнжевый",3000),
                new Pants(Size.XS,"в крапинку",5467),
        };
